                    ...
                    <?php } ?>
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="../Customer/dashboard.php">Go Back</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                    ...
                    echo ' disabled';
                            ...
                            ?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="30"   <?php
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="text"  class="form-control"   maxlength="30"   <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control"  maxlength="10" <?php
                                        ...
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="text" class="form-control" maxlength="18" name="phone"  <?php
                                ...
                                if (!isset($_GET['email'])) {
                                    echo ' disabled';
                                        ...
                                        <div class="form-group">
                                            <label>Job</label>
                                            <input type="text" class="form-control" maxlength="30" name="JobTitle"  <?php
                                            echo 'value="' . $row['JobTitle'] . '"';
                                            if (!isset($_GET['email'])) {
                                                echo ' disabled';
                                            }
